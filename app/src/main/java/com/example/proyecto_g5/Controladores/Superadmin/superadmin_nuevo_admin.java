...
public class superadmin_nuevo_admin extends AppCompatActivity {
    ...
    public  void uploadData( ){
        ...
        Usuario usuario = new Usuario(nombre, apellido, dni,correo, pass_superad, direccion, "administrador", "activo", imageUrl, telefono ,uid, correo_superad, pass_superad, "1");
